...
export const fetchResidentialProjects = () =>
  client.fetch(getResidentialProjectsQuery);
...
export const fetchHospitalityProjects = () =>
  client.fetch(getHospitalityProjectsQuery);
